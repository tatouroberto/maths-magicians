...
**[Math Magicians]** For this project, I used the React.
...
git clone git@github.com:tatouroberto/math-magicians.git
...
Feel free to check the [issues page](https://github.com/tatouroberto/math-magicians/issues).
